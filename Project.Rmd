...
The following distribution of tasks follows the same order as in the table of contents.
Descriptive metrics was done by Javier Ezquerro.
Game performance metrics was done by Marc Soriano.
Visuals were done by Guillem Plademunt and Bernat Garcia (3 visuals each).
AB testing was done by Guillem Plademunt (Test 1) and Marc Soriano (Test 2).
Regression analysis was done by Javier Ezquerro. 
Classification analysis was done by Bernat Garcia.
Finally, the conclusions were written by the whole team collaboratively.
